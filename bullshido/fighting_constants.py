...
ROUND_RESULTS_WIN = [
    ...
    "By the judges reaction, {winner} won that round comfortably!",
    "{winner} raises their hand, they know they won that round!",
    "I think that's a round in the books for {winner}!",
    "{winner} made a statement in that round!",
    "That round was all {winner}!",
    "{winner} dominated that round!",
    "{winner} clearly won that round!",
    "{winner} took that round easily!",
    "{winner} is looking good after that round!",
    "{winner} is in control after that round!",
    "{winner} is ahead after that round!",
    "{winner} looked sharp in that round!",
