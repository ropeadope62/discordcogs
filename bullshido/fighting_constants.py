...
CRITICAL_RESULTS = {
    "{defender} is left in a crumpled heap on the floor.": "Knocked Down",
    "{defender} is left gasping for air.": "Damaged Lung",
    "{defender} is left with a broken nose.": "Broken Nose",
    "{defender} is left with a shattered rib.": "Shattered Rib",
    "{defender} is left with a dislocated shoulder.": "Dislocated Shoulder",
    "{defender} is left with a broken jaw.": "Broken Jaw",
    "{defender} is left with a concussion.": "Concussion",
    "{defender} is left with a broken leg.": "Broken Leg",
    "{defender} is left with a broken arm.": "Broken Arm",
    "{defender} is left with a broken collarbone.": "Broken Collarbone",
    "{defender} is left with a broken wrist.": "Broken Wrist",
    "{defender} is left with a broken ankle.": "Broken Ankle",
    "{defender} is left with a broken finger.": "Broken Finger",
    "{defender} is left with a broken toe.": "Broken Toe",
    "{defender} is left with a broken rib.": "Broken Rib",
    "{defender} is left with a broken shin.": "Broken Shin",
    "{defender} is left with a broken thigh.": "Broken Thigh",
    "{defender} is left with a broken kneecap.": "Broken Kneecap",
    "{defender} is left with a broken foot.": "Broken Foot",
    "{defender} is left with a broken hand.": "Broken Hand",
    "{defender} is cut over the eye.": "Cut Eye",
    "{defender} is left with a black eye.": "Black Eye",
    "{defender} is left with a bloody nose.": "Bloody Nose",
    "{defender} is left with a bloody lip.": "Bloody Lip",
    "{defender} is left with a bloody ear.": "Bloody Ear",
    "{defender} is left with a bloody mouth.": "Bloody Mouth",
    "{defender} is left with a bloody forehead.": "Bloody Forehead",
    "{defender} is left with a bloody cheek.": "Bloody Cheek"
}
KO_MESSAGES = [
